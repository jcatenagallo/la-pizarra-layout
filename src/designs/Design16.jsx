// Design 16: EXPANDABLE STADIUM SCOREBOARD
// Hybrid between Design1 (full events) and Design12 (compact).
// Cards are compact by default; click to expand and reveal full event timeline.
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-2 md:py-4">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <h1 className="font-display text-stadium-ochre text-5xl md:text-6xl tracking-widerr
