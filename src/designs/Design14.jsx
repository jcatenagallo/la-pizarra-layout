// Design 14: COMPACT TRAVEL
// Aesthetic: Design12 compact layout + Design6 travel palette
// Ocean blues, cyan accents, cream warmth, bold red live indicators
...
const FlipDigit = ({ digit, delay = 0 }) => (
  <motion.div
    ...
    className="relative bg-[#0a1929] text-[#1EA4D9] font-display text-lg md:text-xl
...
const ScoreDisplay = ({ home, away }) => {
  ...
  return (
    <div className="flex items-center gap-2 md:gap-3">
      ...
      <span className="text-[#F2E2CE] text-lg md:text-xl font-display">
        -
      </span>
      <div className="flex gap-0.5 md:gap-1">
        {awayDigits.map((d, i) => (
...
const MatchGoalsRow = ({ events }) => {
  ...
  const GoalChip = ({ goal }) => (
    <span className="font-condensed text-[#F2E2CE] text-xs md:text-sm whitespace-nowrap">
      {goal.player} <span className="text-[#23B7D9]">{goal.minute}'</span>
    </span>
  );

  return (
    <div className="border-t border-[#1EA4D9]/20 relative z-10">
      <div className="flex items-center px-2 md:px-4 py-0.5 md:py-1">
        ...
        <div className="w-[70px] md:w-[90px] flex justify-center shrink-0">
          <span className="text-[#1EA4D9]/30 text-[6px]">●</span>
        </div>
      ...
      <div className="flex items-stretch">
        ...
        <div
          className="relative z-10 w-11 md:w-16 shrink-0 flex flex-col items-center justify-center
                        border-r-2 border-[#1EA4D9]/40 py-1.5 md:py-2"
        >
          {isLive ? (
        ...
        <div className="flex-1 relative min-w-0">
          ...
          <div className="relative z-10 flex items-center justify-center gap-1 md:gap-2 px-2 py-1.5 md:px-4 md:py-2">
            ...
            <div className="relative flex-1 flex flex-row items-center justify-end gap-1.5 md:gap-2 min-w-0">
              <div className="font-display font-semibold text-[#F2E2CE] text-xs md:text-lg lg:text-xl tracking-wider text-right leading-tight truncate">
                {homeTeam?.name}
              </div>
            ...
            <div className="relative flex-1 flex flex-row items-center justify-start gap-1.5 md:gap-2 min-w-0">
              ...
              <div className="font-display font-semibold text-[#F2E2CE] text-xs md:text-lg lg:text-xl tracking-wider text-left leading-tight truncate">
                {awayTeam?.name}
              </div>
            </div>
          </div>
...
const LeagueSection = ({ leagueId, matchList }) => {
  ...
  return (
    <div className="mb-3 md:mb-6">
      ...
      <div
        className="border-2 border-[#1EA4D9]/40 rounded-lg overflow-hidden
                      bg-[#0a1929]
      ...
      >
        ...
        >
          ...
          <h3
            className="font-display text-[#0a1929] text-base tracking-wider
                         drop-shadow-[0_1px_0_rgba(255,255,255,0.2)]"
          >
            {league?.name}
          </h3>
          <div className="flex-1 h-px bg-gradient-to-r from-[#0a1929]/20 to-transparent ml-2" />
          <span className="font-condensed text-[#0a1929] text-[10px] tracking-widerr">
  ...
  return (
    <div className="bg-[#0a1929]/80 rounded-lg p-4 border-2 border-[#1EA4D9]/20">
      ...
      <div className="border-t border-[#1EA4D9]/20 pt-4">
        <h4 className="font-display text-[#F2E2CE]/60 text-base mb-3 tracking-wider">
          POR PAÍS
        </h4>
        {countries.map((country) => {
          ...
          return (
            <div
              key={country.id}
              className="mb-3 border border-[#1EA4D9]/20 rounded-lg overflow-hidden"
            >
    ...
    <div className="min-h-screen bg-[#0c1520]">
      ...
      <header className="relative overflow-hidden border-b-2 border-[#1EA4D9]">
        ...
        <div className="absolute inset-0">
          <div
            className="absolute top-0 left-1/4 w-32 h-full bg-gradient-to-b from-[#1EA4D9]/10 to-transparent
                          transform -skew-x-12"
          />
          <div
            className="absolute top-0 right-1/3 w-24 h-full bg-gradient-to-b from-[#23B7D9]/5 to-transparent
                          transform skew-x-6"
          />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-2 md:py-4">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <h1
                className="font-display text-[#1EA4D9] text-5xl md:text-6xl tracking-widerr
              ...
              {[...liveMatches, ...liveMatches].map((match, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[#F2E2CE]/60 mr-3">
                      {match.minute}'
                    </span>
                    {home?.name}
                    <img
                    ...
                    />
                    <span className="font-bold text-[#F2E2CE]">
      ...
      <main className="relative">
        ...
        >
          <TacticalBackground
            ...
            color="#1EA4D9"
          />
          <TacticalElements opacity={0.1} color="#1EA4D9" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 md:px-4 pt-0 pb-2 md:py-8">
          <div className="flex flex-col lg:flex-row gap-3 lg:gap-8">
            ...
            <MobileSidebar selectedLeague={selectedLeague} variant="travel">
              <LeaguesSidebar
                selectedLeague={selectedLeague}
                onLeagueSelect={(id) =>
                  setSelectedLeague(id === selectedLeague ? null : id)
            ...
            <div className="flex-1 lg:order-2">
              ...
              {Object.keys(groupedMatches).length === 0 && (
                <div className="text-center py-16">
                  <Landmark
                    size={64}
                    className="mx-auto mb-4 text-[#F2E2CE]/40"
                  />
      ...
      {/* Footer */}
      <footer className="border-t-2 border-[#1EA4D9]/30 mt-12 py-6">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="font-condensed text-[#F2E2CE]/30 text-sm tracking-widerr">
