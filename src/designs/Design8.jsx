// Design 12: BOSQUE NOCTURNO (inverted Design10)
// Aesthetic: Deep forest at night — dark green background with warm cream/ivory
// match cards, sage accents, and an inverted botanical feel
...
const FlipDigit = ({ digit, delay = 0 }) => (
  <motion.div
    ...
    className="relative bg-[#02402E] text-[#F0F2DC] font-display text-xl md:text-2xl
               w-8 md:w-9 h-8 md:h-9 flex items-center justify-center
               rounded-sm shadow-[inset_0_2px_4px_rgba(0,0,0,0.3),0_4px_8px_rgba(0,0,0,0.15)]
               border-t border-[#4D7361]/30"
    style={{ perspective: '500px', transformStyle: 'preserve-3d' }}
  >
    <span className="drop-shadow-[0_1px_1px_rgba(0,0,0,0.4)]">{digit}</span>
...
const ScoreDisplay = ({ home, away, isLive }) => {
  ...
  return (
    <div className="flex items-center gap-2 md:gap-3">
      ...
      <span className="text-[#02402E] text-xl md:text-2xl font-display">
        -
      </span>
      <div className="flex gap-0.5 md:gap-1">
...
const GoalIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className="inline-block">
    <path
      ...
      fill="none"
    />
    <line x1="3" y1="10" x2="21" y2="10" stroke="#02402E" strokeWidth="0.75" opacity="0.6" />
    <line x1="3" y1="14" x2="21" y2="14" stroke="#02402E" strokeWidth="0.75" opacity="0.6" />
    <line x1="3" y1="18" x2="21" y2="18" stroke="#02402E" strokeWidth="0.75" opacity="0.6" />
    <line x1="7" y1="6" x2="7" y2="20" stroke="#02402E" strokeWidth="0.75" opacity="0.6" />
    <line x1="12" y1="6" x2="12" y2="20" stroke="#02402E" strokeWidth="0.75" opacity="0.6" />
    <line x1="17" y1="6" x2="17" y2="20" stroke="#02402E" strokeWidth="0.75" opacity="0.6" />
  </svg>
);
...
const MatchEventsPanel = ({ events }) => {
  ...
  return (
    <div className="border-t-2 border-[#02402E]/20">
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 flex items-center justify-end gap-1 md:gap-2">
                {isHome && (
                  event.type === 'substitution' ? (
                    ...
                    <span className="font-condensed text-[#01261C] text-xs md:text-sm text-right">
                      {event.player}
                    </span>
                  )
                )}
              ...
              <div className="w-9 md:w-12 flex justify-center">
                <span className="font-condensed text-[#4D7361] text-xs md:text-sm font-semibold">
                  {event.minute}'
                </span>
              </div>
              ...
              <div className="flex-1 flex items-center justify-start gap-1 md:gap-2">
                {!isHome && (
                  event.type === 'substitution' ? (
                    ...
                    <span className="font-condensed text-[#01261C] text-xs md:text-sm">
                      {event.player}
                    </span>
                  )
                )}
  ...
  return (
    <div
      className="relative rounded-none md:rounded-xl overflow-hidden
                 border-x-0 md:border-x-2 border-y border-[#02402E]/20 md:shadow-lg
                 bg-gradient-to-br from-[#F0F2DC] via-[#EAECCE] to-[#E4E6C4]"
    >
      {/* Subtle texture */}
      ...
      <div className="flex items-stretch">
        ...
        <div className="relative z-10 w-12 md:w-20 shrink-0 flex flex-col items-center justify-center
                        border-r-2 border-[#02402E]/20 py-2 md:py-3">
          {isLive ? (
            <span className="font-condensed text-[#02402E] font-bold text-base md:text-2xl">
              {match.minute}'
            </span>
          ) : isFinished ? (
            <span className="font-condensed text-[#02402E] font-bold text-xs md:text-xl">
              FIN
            </span>
          ) : (
            <span className="font-condensed text-[#02402E] font-bold text-base md:text-2xl">
          ...
          <div className="relative z-10 flex items-center justify-center gap-1.5 md:gap-4 px-2 py-2 md:px-4 md:py-3">
            ...
            <div className="flex-1 flex flex-col items-center md:flex-row md:items-center md:justify-end gap-0.5 md:gap-2 min-w-0">
              <img
                src={homeTeam?.logo}
                alt={homeTeam?.name}
                className="w-7 h-7 md:w-10 md:h-10 object-contain shrink-0 drop-shadow-md md:order-2"
              />
              <div className="font-display text-[#01261C] text-xs md:text-lg lg:text-xl tracking-wide md:order-1 text-center md:text-right leading-tight md:truncate">
                {homeTeam?.name}
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center md:flex-row md:items-center md:justify-start gap-0.5 md:gap-2 min-w-0">
              <img
                src={awayTeam?.logo}
                alt={awayTeam?.name}
                className="w-7 h-7 md:w-10 md:h-10 object-contain shrink-0 drop-shadow-md"
              />
              <div className="font-display text-[#01261C] text-xs md:text-lg lg:text-xl tracking-wide text-center md:text-left leading-tight md:truncate">
                {awayTeam?.name}
              </div>
            </div>
          </div>
...
const LeagueSection = ({ leagueId, matchList }) => {
  ...
  return (
    <div className="mb-3 md:mb-6">
      ...
      <div className="border-2 border-[#4D7361]/30 rounded-lg overflow-hidden
                      bg-[#01261C]
                      shadow-[0_4px_20px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(77,115,97,0.1)]">

        {/* Header row */}
        <div className="flex items-center gap-3 px-4 py-3
                        bg-gradient-to-r from-[#F0F2DC] via-[#E8EACC] to-[#F0F2DC]
                        border-b-2 border-[#02402E]/30">
          {league?.logo ? (
          ...
          <h3 className="font-display text-[#01261C] text-xl tracking-wide
                         drop-shadow-[0_1px_0_rgba(255,255,255,0.3)]">
            {league?.name}
          </h3>
          <div className="flex-1 h-px bg-gradient-to-r from-[#02402E]/20 to-transparent ml-2" />
          <span className="font-condensed text-[#02402E] text-xs tracking-wider">
        ...
        return (
          <motion.button
            ...
            className={`
              ...
              ${isSelected
                ? 'bg-[#F0F2DC] text-[#01261C] shadow-lg'
                : 'bg-[#02402E]/50 text-[#F0F2DC]/60 hover:bg-[#02402E]/80'}
              ${isToday && !isSelected ? 'ring-2 ring-[#F0F2DC]/40' : ''}
            `}
          >
...
const LeaguesSidebar = ({ selectedLeague, onLeagueSelect }) => {
  ...
  return (
    <div className="bg-[#02402E]/60 rounded-lg p-4 border-2 border-[#4D7361]/20">
      <div className="mb-6 border-2 border-[#4D7361]/30 rounded-lg overflow-hidden">
        <div className="flex items-center gap-2 text-[#F0F2DC] py-2.5 px-3 bg-[#4D7361]/20">
          <span className="font-display text-lg uppercase tracking-wide font-semibold">Destacados</span>
        </div>
        <div className="divide-y divide-[#4D7361]/20">
          {featured.map(league => (
            <button
              key={league.id}
              ...
              className={`
                ...
                ${selectedLeague === league.id
                  ? 'bg-[#F0F2DC] text-[#01261C] font-semibold'
                  : 'text-[#F0F2DC]/90 hover:bg-[#4D7361]/20'}
              `}
            >
              <motion.span
                whileHover={{ x: 4 }}
      ...
      <div className="border-t border-[#4D7361]/20 pt-4">
        <h4 className="font-display text-[#F0F2DC]/50 text-base mb-3 tracking-wide">
          POR PAÍS
        </h4>
        {countries.map(country => {
          ...
          return (
            <div key={country.id} className="mb-3 border border-[#4D7361]/20 rounded-lg overflow-hidden">
              <div className="flex items-center gap-2 text-[#F0F2DC] text-sm py-2 px-3 bg-[#4D7361]/10">
                ...
                {countryLeagues.map(league => (
                  <button
                    ...
                    className={`
                      ...
                      ${selectedLeague === league.id
                        ? 'text-[#F0F2DC] bg-[#4D7361]/20 font-semibold'
                        : 'text-[#F0F2DC]/90 hover:bg-[#4D7361]/15'}
                    `}
                  >
                    <motion.span
                      whileHover={{ x: 4 }}
...
export default function Design8({ showLiveTicker = true, tickerPosition = 'top' }) {
  ...
  return (
    <div className="min-h-screen bg-[#01261C]">

      {/* Header */}
      <header className="relative overflow-hidden border-b-2 border-[#4D7361]">
        {/* Light beams */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-32 h-full bg-gradient-to-b from-[#F0F2DC]/6 to-transparent
                          transform -skew-x-12" />
          <div className="absolute top-0 right-1/3 w-24 h-full bg-gradient-to-b from-[#4D7361]/8 to-transparent
                          transform skew-x-6" />
        </div>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <PizarraLogo
                ...
                animated={false}
              />
              <h1 className="font-display text-[#F0F2DC] text-5xl md:text-6xl tracking-wider
            ...
            <p className="font-condensed text-[#F0F2DC]/40 text-[10px] md:text-xs tracking-[0.4em] uppercase -mt-1 md:mt-1">
        ...
        <div className="bg-[#4D7361] border-y-2 border-[#02402E]/50 overflow-hidden">
          <div className="flex items-stretch relative">
            <div className="bg-[#01261C] px-4 flex items-center gap-2 shrink-0 relative z-10">
              ...
              />
              <span className="font-display text-[#F0F2DC] text-sm tracking-wider">EN VIVO</span>
            </div>
            <motion.div
              animate={{ x: [0, -2000] }}
            ...
            >
              {[...liveMatches, ...liveMatches].map((match, idx) => {
                ...
                return (
                  <span key={idx} className="font-condensed text-[#F0F2DC] text-sm flex items-center">
                    <span className="h-6 w-px bg-[#F0F2DC]/30 mx-8" />
                    <span className="text-[#F0F2DC]/60 mr-3">{match.minute}'</span>
                    {home?.name}
                    <img src={home?.logo} alt="" className="w-5 h-5 object-contain mx-1.5" />
                    <span className="font-bold text-[#F0F2DC]">{match.homeScore} - {match.awayScore}</span>
      ...
      <main className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 md:px-4 pt-0 pb-2 md:py-8">
          <div className="flex flex-col lg:flex-row gap-3 lg:gap-8">
            ...
            <MobileSidebar variant="bosqueNoche" selectedLeague={selectedLeague} bottomOffset={tickerPosition === 'bottom' && showLiveTicker && liveMatches.length > 0}>
              <LeaguesSidebar
                selectedLeague={selectedLeague}
                onLeagueSelect={(id) => setSelectedLeague(id === selectedLeague ? null : id)}
              />
            ...
            <div className="flex-1 lg:order-2">
              ...
              {Object.keys(groupedMatches).length === 0 && (
                <div className="text-center py-16">
                  <Landmark size={64} className="mx-auto mb-4 text-[#F0F2DC]/30" />
                  <p className="font-display text-[#F0F2DC]/30 text-xl">
                    NO HAY PARTIDOS
                  </p>
                </div>
              )}
      ...
      {/* Footer */}
      <footer className={`border-t-2 border-[#4D7361]/20 mt-12 py-6 ${tickerPosition === 'bottom' && showLiveTicker && liveMatches.length > 0 ? 'pb-16' : ''}`}>
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="font-condensed text-[#F0F2DC]/30 text-sm tracking-wider">
      ...
      {showLiveTicker && tickerPosition === 'bottom' && liveMatches.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#4D7361] border-t-2 border-[#02402E]/50 overflow-hidden shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
          <div className="flex items-stretch relative">
            <div className="bg-[#01261C] px-4 flex items-center gap-2 shrink-0 relative z-10">
              <motion.div
                animate={{ scale: [1, 1.2, 1] }}
