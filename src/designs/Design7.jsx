// Design 10: BOSQUE
// Aesthetic: Botanical garden scoreboard — warm ivory background with deep forest green
// accents, sage midtones, and a serene light-theme feel
...
const FlipDigit = ({ digit, delay = 0 }) => (
  <motion.div
    ...
    className="relative bg-[#01261C] text-[#F0F2DC] font-display text-xl md:text-2xl
...
const ScoreDisplay = ({ home, away, isLive }) => {
  ...
  return (
    <div className="flex items-center gap-2 md:gap-3">
      ...
      <span className="text-[#01261C] text-xl md:text-2xl font-display">
        -
      </span>
      <div className="flex gap-0.5 md:gap-1">
...
const MatchEventsPanel = ({ events }) => {
  ...
  return (
    <div className="border-t-2 border-[#4D7361]/40">
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 flex items-center justify-end gap-1 md:gap-2">
                {isHome && (
                  event.type === 'substitution' ? (
                    ...
                    <span className="font-condensed text-[#F0F2DC] text-xs md:text-sm text-right">
                      {event.player}
                    </span>
                  )
                )}
              ...
              <div className="w-9 md:w-12 flex justify-center">
                <span className="font-condensed text-[#F0F2DC]/80 text-xs md:text-sm font-semibold">
                  {event.minute}'
                </span>
              </div>
              ...
              <div className="flex-1 flex items-center justify-start gap-1 md:gap-2">
                {!isHome && (
                  event.type === 'substitution' ? (
                    ...
                    <span className="font-condensed text-[#F0F2DC] text-xs md:text-sm">
                      {event.player}
                    </span>
                  )
                )}
    ...
    >
      ...
      <div className="flex items-stretch">
        ...
        <div className="relative z-10 w-12 md:w-20 shrink-0 flex flex-col items-center justify-center
                        border-r-2 border-[#4D7361]/40 py-2 md:py-3">
          {isLive ? (
        ...
        <div className="flex-1 relative min-w-0">
          ...
          <div className="relative z-10 flex items-center justify-center gap-1.5 md:gap-4 px-2 py-2 md:px-4 md:py-3">
            ...
            <div className="flex-1 flex flex-col items-center md:flex-row md:items-center md:justify-end gap-0.5 md:gap-2 min-w-0">
              ...
              />
              <div className="font-display text-[#F0F2DC] text-xs md:text-lg lg:text-xl tracking-wide md:order-1 text-center md:text-right leading-tight md:truncate">
                {homeTeam?.name}
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center md:flex-row md:items-center md:justify-start gap-0.5 md:gap-2 min-w-0">
              ...
              />
              <div className="font-display text-[#F0F2DC] text-xs md:text-lg lg:text-xl tracking-wide text-center md:text-left leading-tight md:truncate">
                {awayTeam?.name}
              </div>
            </div>
          </div>
...
const LeagueSection = ({ leagueId, matchList }) => {
  ...
  return (
    <div className="mb-3 md:mb-6">
      ...
      <div className="border-2 border-[#02402E]/30 rounded-lg overflow-hidden
                      bg-[#F0F2DC]
        ...
        <div className="flex items-center gap-3 px-4 py-3
          ...
          <h3 className="font-display text-[#F0F2DC] text-xl tracking-wide
                         drop-shadow-[0_1px_0_rgba(0,0,0,0.3)]">
            {league?.name}
          </h3>
          <div className="flex-1 h-px bg-gradient-to-r from-[#F0F2DC]/20 to-transparent ml-2" />
          <span className="font-condensed text-[#F0F2DC]/80 text-xs tracking-wider">
  ...
  return (
    <div className="bg-[#F0F2DC] rounded-lg p-4 border-2 border-[#02402E]/20">
      ...
      <div className="border-t border-[#02402E]/20 pt-4">
        <h4 className="font-display text-[#01261C]/50 text-base mb-3 tracking-wide">
          POR PAÍS
        </h4>
        {countries.map(country => {
          ...
          return (
            <div key={country.id} className="mb-3 border border-[#02402E]/20 rounded-lg overflow-hidden">
...
export default function Design7({ showLiveTicker = true, tickerPosition = 'top' }) {
    ...
    <div className="min-h-screen bg-[#F0F2DC]">
      ...
      <header className="relative overflow-hidden border-b-2 border-[#02402E]">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-32 h-full bg-gradient-to-b from-[#02402E]/8 to-transparent
                          transform -skew-x-12" />
          <div className="absolute top-0 right-1/3 w-24 h-full bg-gradient-to-b from-[#4D7361]/5 to-transparent
                          transform skew-x-6" />
        </div>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <PizarraLogo
                ...
                animated={false}
              />
              <h1 className="font-display text-[#02402E] text-5xl md:text-6xl tracking-wider
      ...
      <main className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 md:px-4 pt-0 pb-2 md:py-8">
          <div className="flex flex-col lg:flex-row gap-3 lg:gap-8">
            ...
            <MobileSidebar variant="bosque" selectedLeague={selectedLeague} bottomOffset={tickerPosition === 'bottom' && showLiveTicker && liveMatches.length > 0}>
              <LeaguesSidebar
                selectedLeague={selectedLeague}
                onLeagueSelect={(id) => setSelectedLeague(id === selectedLeague ? null : id)}
              />
            ...
            <div className="flex-1 lg:order-2">
              ...
              {Object.keys(groupedMatches).length === 0 && (
                <div className="text-center py-16">
                  <Landmark size={64} className="mx-auto mb-4 text-[#01261C]/30" />
      ...
      {/* Footer */}
      <footer className={`border-t-2 border-[#02402E]/20 mt-12 py-6 ${tickerPosition === 'bottom' && showLiveTicker && liveMatches.length > 0 ? 'pb-16' : ''}`}>
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="font-condensed text-[#01261C]/30 text-sm tracking-wider">
      ...
      {showLiveTicker && tickerPosition === 'bottom' && liveMatches.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#4D7361] border-t-2 border-[#02402E]/50 overflow-hidden shadow-[0_-4px_20px_rgba(0,0,0,0.2)]">
          <div className="flex items-stretch relative">
            <div className="bg-[#01261C] px-4 flex items-center gap-2 shrink-0 relative z-10">
              <motion.div
                animate={{ scale: [1, 1.2, 1] }}
